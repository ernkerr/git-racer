      ...
      >
        ...
        <div className="space-y-2">
          ...
          >
            ...
            <span className="font-pixel text-xs text-arcade-white">LINKEDIN</span>
          </button>
          ...
          >
            ...
            <span className="font-pixel text-xs text-arcade-white">REDDIT</span>
          </button>
          ...
          >
            ...
            <span className="font-pixel text-xs text-arcade-white">FACEBOOK</span>
          </button>
          ...
          >
            ...
            <span className="font-pixel text-xs text-arcade-white">WHATSAPP</span>
          </button>
          ...
          >
            ...
            <span className="font-pixel text-xs text-arcade-white">TELEGRAM</span>
          </button>
          ...
          <button
            onClick={() => {
              window.open(
                `mailto:?subject=${encodeURIComponent("Check out this Git Racer race!")}&body=${encodeURIComponent(shareText + "\n\n" + shareUrl)}`,
                "_self"
              );
              onClose();
            }}
          ...
          >
            ...
            <span className="font-pixel text-xs text-arcade-white">EMAIL</span>
          </button>

          {/* Native share (mobile — covers TikTok, Instagram, etc.) */}
          {canNativeShare && (
            <button
